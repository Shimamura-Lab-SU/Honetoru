...
function Honetoru
	...
	TXT_In1		= uicontrol(SettingTab,'Style','text',...
				...
				'FontSize',10);
	% Create Pop-up
	POP_In1		= uicontrol(SettingTab,'Style', 'popupmenu',...
	...
	TXT_In2		= uicontrol(SettingTab,'Style','text',...
				...
				'FontSize',10);
	% Create Pop-up
	POP_In2		= uicontrol(SettingTab,'Style', 'popupmenu',...
				'String',InputDeviceName,...
...
% 	POP_Noise.Value = 2;							% Initial : White Noise
	...
	TXT_Out		= uicontrol(SettingTab,'Style','text',...
				...
				'FontSize',10);
	% Create Pop-up
	POP_Out		= uicontrol(SettingTab,'Style', 'popupmenu',...
	...
	% ----------------------------
	TXT_Norm3	= uicontrol(SettingTab,'Style','checkbox',...
				'String', '  Automatic Output Volume Control',...
				'Value',1,...
				'Position', [270 8 250 16],...
				'HorizontalAlignment','left',...
				'FontSize',10);
